...
cur.execute("update exp_data_proposal_test set selected_spot1='" + str(check1) + "', selected_spot2='" + str(check2) + "', selected_spot3='" + str(check3) + "', msg ='" + str(msg) + "',count = '" + str(count) +  "', access_order=0 where id=" + str(user_max_id) + ";")
