...
category_id = int(form.getvalue('genre')) ## only_type1_1.pyのgenreを受け取る
...
print("<p style='text-align:center;'>要求を3つ入力してください．</p>")
# <br><span style='font-size:12px;'>例：広い,のんびり,自然豊か...</span></p>")
