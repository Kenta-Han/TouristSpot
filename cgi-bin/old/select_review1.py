...
## ====== レビュー(ランダム表示) ======
c.execute("select cast(num as char),review_text from unity_kantou where companion='" + type_word[2] +"' order by rand() limit 20")
...
pulldown = """
<p>レビュー1： <select name='input1' form='example'>
...
&nbsp&nbsp&nbsp レビュー2： <select name='input2' form='example'>
<option value='1'>1</option>
<option value='2'>2</option>
<option value='3'>3</option>
<option value='4'>4</option>
...
&nbsp&nbsp&nbsp レビュー3： <select name='input3' form='example'>
<option value='1'>1</option>
<option value='2'>2</option>
<option value='3'>3</option>
<option value='4'>4</option>
...
print("<form method='post' action='recommend1.py' id='example'>")
print("<h4><input type='radio' name='type1' value='"+type1+"'>タイプ確認: "+type_all[int(type1)-1]+"</h4>")
...
print("<br/><input type='submit' value='送信' class='submit1'/><br/><br/>")
print("<input type='button' value='リセット' onclick='this.form.reset();' class='submit1'/>")
