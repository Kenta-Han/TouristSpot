...
sql_update = "UPDATE map_test SET hyouka_name_c='{hyouka_name_c}', hyouka_word_c='{hyouka_word_c}', hyouka_name_f='{hyouka_name_f}', hyouka_word_f='{hyouka_word_f}', hyouka_name_v='{hyouka_name_v}', hyouka_word_v='{hyouka_word_v}', hyouka_word_v_m='{hyouka_word_v_m}', finish_datetime='{finish}' WHERE id = {record_id};".format(hyouka_name_c='，'.join(hyouka_name_category), hyouka_word_c='，'.join(hyouka_word_category), hyouka_name_f='，'.join(hyouka_name_feature), hyouka_word_f='，'.join(hyouka_word_feature), hyouka_name_v='，'.join(hyouka_name_vector), hyouka_word_v='，'.join(hyouka_word_vector), hyouka_word_v_m='，'.join(hyouka_word_vector_m), finish=finish_datetime, record_id=record_id)
