...
print("<form action='only_type1.py' method='post'>")
...
c.execute("update exp_data_category_test set selected_spot1='" + str(check1) + "', selected_spot2='" + str(check2) + "', selected_spot3='" + str(check3) + "', msg ='" + str(msg) + "',count = '" + str(count) +  "' where id=" + str(user_max_id) + ";")
