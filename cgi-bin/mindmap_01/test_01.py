...
<h4 class='keyword'>都道府県：<input type='text' name='prefecture_name' style='width: 250px;height: 24px;font-size:16px;'/></h4>
<h4 class='keyword'>エリア：<input type='text' name='area_name' style='width: 250px;height: 24px;font-size:16px;'/></h4>
