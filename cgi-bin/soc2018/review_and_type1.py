...
c.execute(sql_insert,(user_id,type_word[2],season_word[2],keyword[0],keyword[1],keyword[2],"3",start_datetime))
connect.commit()
...
print("<form method='post' action='review_and_type2.py' id='example'>")
